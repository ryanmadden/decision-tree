...
* datatypes.csv - A metadata file that indicates (with comma separated true/false entries) which attributes are numeric (true) and nominal (false)

HOW TO RUN
Note: You must edit datatypes.csv file or supply your own datatype file if using a different dataset than the one provided
